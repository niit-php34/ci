...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo base_url() ?>statics/font-awesome/css/font-awesome.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo base_url() ?>statics/admin-lte/css/AdminLTE.min.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
   folder instead of downloading all of them to reduce the load. -->
   <link rel="stylesheet" href="<?php echo base_url() ?>statics/admin-lte/css/skins/_all-skins.min.css">
...
<!-- /.control-sidebar -->
 ...
 <!-- jQuery 3 -->
 <script src="<?php echo base_url() ?>statics/jquery/jquery.min.js"></script>
 <!-- jQuery UI 1.11.4 -->
...
<!--  <script>
 ...
 <!-- AdminLTE App -->
 <script src="<?php echo base_url() ?>statics/admin-lte/js/adminlte.min.js"></script>
